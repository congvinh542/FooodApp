...
namespace ClickBuy_Api.WebAdmin.Controllers
{
    ...
    public class OrderController : BaseController<IOrderService>
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> GetAll([FromQuery] BaseFilter<OrderFilter> query)
        {
        ...
        [HttpPost("create")]
        public async Task<IActionResult> Create(OrderQuery query)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(OrderQuery query)
        {

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Imagess_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeShip = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_Imagess_ImagesId",
                        column: x => x.ImagesId,
                        principalTable: "Imagess",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Huyens_HuyenId",
                        column: x => x.HuyenId,
                        principalTable: "Huyens",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Imagess_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Imagess",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Tinhs_TinhId",
                        column: x => x.TinhId,
                        principalTable: "Tinhs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Xas_XaId",
                        column: x => x.XaId,
                        principalTable: "Xas",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TinhId",
                table: "AspNetUsers",
                column: "TinhId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_XaId",
                table: "AspNetUsers",
                column: "XaId");

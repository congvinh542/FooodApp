...
namespace ClickBuy_Api.WebAdmin.Controllers
{
    ...
    [Authorize]
    public class TinhController : BaseController<ITinhService>
    {
        public TinhController(ITinhService service) : base(service)
        {
        }
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> GetAll([FromQuery] BaseFilter<TinhFilter> query)
        {
        ...
        [HttpPost("create")]
        public async Task<IActionResult> Create(TinhQuery query)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(TinhQuery query)
        {
